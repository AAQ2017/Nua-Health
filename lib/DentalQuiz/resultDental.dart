...
//Remark Logic
  String get resultPhrase {
    String resultText;
    if (resultScore >= 19) {
      resultText = 'Based on your responses you should see a dental professional urgently.\n\n You may be experiencing pain or conditions that need to be addressed as soon as possible.\n\nPlease visit our In Your Area tab to find clinics near you!';
    } else if (resultScore >= 12) {
      resultText = 'Based on your responses you should see a dental professional soon.\n\nYou may be experiencing pain or conditions that are safe to be addressed at a later time. \n Note: It is highly recommended you visit the dentist once every 6 months!\n\nPlease visit our In Your Area tab to find clinics near you';
    } else if (resultScore < 12) {
      resultText = 'Based on your responses you should see a dental professional at your convenience.\n\nYou may be experiencing issues that can be safely addressed at a later time.\n\nPlease visit our In Your Area tab to find clinics near you!';
    }
    return resultText;
  }
